  ...
  render() {
    return (
      <div className="Header">
        <nav className="navbar navbar-expand-lg navbar-dark bg-dark" id="mt-navbar">
            <img src={require('../img/movietimecom-transparent-crop.png')} alt="" height="50px"/>
            <span className="mt-navbar-space"></span>
            <a class="navbar-brand mt-font" href="#">The Easiest Way to Buy Theater Ticket!</a>            
