        ...
        <div id="carouselExampleIndicators" className="carousel slide" data-ride="carousel">
            ...
            <div className="carousel-inner">
                <div className="carousel-item active mt-slider">
                    <img className="d-block w-100 mt-slider-crop" src={require('../img/rz3TAyd5kmiJmozp3GUbYeB5Kep.jpg')} alt="Third slide"/>
                ...
                <div className="carousel-item mt-slider">
                    <img className="d-block w-100 mt-slider-crop" src={require('../img/xVCwX0p8uZ0ieD8JozZmdi1wUjK.jpg')} alt="Second slide"/>
                    <div className="carousel-caption d-none d-md-block">
                ...
                <div className="carousel-item mt-slider">
                    <img className="d-block w-100 mt-slider-crop" src={require('../img/zBIfBeStaDdDdhBrSx8InhgFUVa.jpg')} alt="First slide" />
                    <div className="carousel-caption d-none d-md-block">
                        <div>
                            <h1>Ocean's 8</h1>
